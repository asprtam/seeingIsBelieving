    ...
    useEffect(() => {
        ...
        window.addEventListener('scroll', () => {
            if(media[0].matches || media[1].matches) {
                ...
                if (newScroll < oldScroll || newScroll < 10) {
                    gsap.to(menu.current, {y: -menu.current.offsetHeight*1.01, duration: 0.5,  ease: "power2.out"});
                } else {
                    gsap.to(menu.current, {y: -menu.current.offsetHeight*2.01, duration: 0.5,  ease: "power2.out"});
                }
                oldScroll = newScroll;
            }
        })
    ...
    return (
        <div ref={menu} className="Menu">
            <button className="Sections">
                <span>Sections</span>
                <svg className="Hamburger" viewBox="0 0 100 80" role="img">
